...
if task == "Task 1 – Preference vs Work Type":
    ...
    filtered = filtered[
        (filtered["Job Title"].str.split().str.len().fillna(0) == 1) &
    ...
    pref_counts = filtered["Preference"].value_counts().reset_index()
...
# ===================================================
    ...
    filtered = filtered[
        filtered["Contact Person"].str.endswith(("a", "e", "i", "o", "u"), na=False)
    ]
...
# ===================================================
    ...
    filtered = filtered[filtered["Company"].str.len().fillna(0) > 8]
